...
DATA_DIR="${DATA_DIR:-$RESULTS_ROOT/data}"
LOG_DIR="${LOG_DIR:-$RESULTS_ROOT/logs}"
MANIFEST_PATH="${MANIFEST_PATH:-$RESULTS_ROOT/run_manifest.csv}"
MANIFEST_MODE="${MANIFEST_MODE:-overwrite}"
# 0 means no runner timeout (allow long-running points).
...
# Set a very high slow-latency threshold for Exp3:
# baseline(0.01s) * 60000 = 600s (10 minutes).
SLOW_LATENCY_MULTIPLIER="${SLOW_LATENCY_MULTIPLIER:-60000}"
